                ...
                <div class="lg:col-span-1">
                  <div class="grid grid-cols-2 gap-5 lg:gap-7.5 h-full items-stretch">
                    ...
                    <div
                      ...
                      <img alt="" class="w-7 mt-4 ms-5" src="/metronic/assets/media/brand-logos/linkedin-2.svg" />
                    ...
                    <div
                      class="kt-card flex-col justify-between gap-6 h-full bg-cover rtl:bg-[left_top_-1.7rem] bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
                      <img alt="" class="w-7 mt-4 ms-5" src="/metronic/assets/media/brand-logos/youtube-2.svg" />
                      <div class="flex flex-col gap-1 pb-4 px-5">
                        <span class="text-3xl font-semibold text-mono">
                          24k
                        </span>
                    ...
                    <div
                      class="kt-card flex-col justify-between gap-6 h-full bg-cover rtl:bg-[left_top_-1.7rem] bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg">
                      <img alt="" class="w-7 mt-4 ms-5" src="/metronic/assets/media/brand-logos/instagram-03.svg" />
                      <div class="flex flex-col gap-1 pb-4 px-5">
                        <span class="text-3xl font-semibold text-mono">
                          608
                        </span>
                    ...
                    <div
                      ...
                      <img alt="" class="dark:hidden w-7 mt-4 ms-5"
                        src="/metronic/assets/media/brand-logos/tiktok.svg" />
                      <img alt="" class="hidden dark:block w-7 mt-4 ms-5"
                        src="/metronic/assets/media/brand-logos/tiktok-dark.svg" />
                      <div class="flex flex-col gap-1 pb-4 px-5">
                        <span class="text-3xl font-semibold text-mono">
                          2.5k
                        </span>
                  ...
                  <div class="kt-card h-full">
                    <div class="kt-card-content lg:p-7.5 lg:pt-6 p-5">
                      <div class="flex items-center justify-between flex-wrap gap-5 mb-7.5">
                        ...
                        <img alt="" class="size-7" src="/metronic/assets/media/brand-logos/zoom.svg">
                      </div>
                                  ...
                                  <td>
                                    <div class="flex -space-x-2">
                                      <div class="flex">
                                        <img
                                          class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                          src="/metronic/assets/media/avatars/300-24.png">
                                      </div>
                                      <div class="flex">
                                        <img
                                          class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                          src="/metronic/assets/media/avatars/300-7.png">
                                      </div>
                                    </div>
                                  </td>
                                </tr>
                                  ...
                                  <td>
                                    <div class="flex -space-x-2">
                                      ...
                                      <div class="flex">
                                        <img
                                          class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                          src="/metronic/assets/media/avatars/300-8.png">
                                      </div>
                                      <div class="flex">
                                        <img
                                          class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                          src="/metronic/assets/media/avatars/300-9.png">
                                      </div>
                                      <div class="flex">
                                        <span
    ...
    <div class="kt-modal" data-kt-modal="true" id="search_modal">
      <div class="kt-modal-content max-w-[600px] top-[15%]">
        ...
        <div class="kt-modal-body p-0 pb-5">
          ...
          <div class="kt-srcollable-y-auto" data-kt-srcollable="true" data-kt-srcollable-max-height="auto"
            data-kt-srcollable-offset="300px">
                      ...
                      <div class="kt-menu-link flex items-center jistify-between gap-2">
                        ...
                        <div class="flex justify-end shrink-0">
                          <div class="flex -space-x-2">
                            <div class="flex">
                              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                src="/metronic/assets/media/avatars/300-14.png" />
                            </div>
                            <div class="flex">
                              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                src="/metronic/assets/media/avatars/300-12.png" />
                            </div>
                            <div class="flex">
                              <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                                src="/metronic/assets/media/avatars/300-9.png" />
                  ...
                  <div class="kt-menu-link flex items-center jistify-between gap-2">
                    ...
                    <div class="flex justify-end shrink-0">
                      <div class="flex -space-x-2">
                        <div class="flex">
                          <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                            src="/metronic/assets/media/avatars/300-6.png" />
                        </div>
                        <div class="flex">
                          <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                            src="/metronic/assets/media/avatars/300-3.png" />
                  ...
                  <div class="kt-menu-link flex items-center jistify-between gap-2">
                    ...
                    <div class="flex justify-end shrink-0">
                      <div class="flex -space-x-2">
                        <div class="flex">
                          <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                            src="/metronic/assets/media/avatars/300-18.png" />
                        </div>
                        <div class="flex">
                          <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                            src="/metronic/assets/media/avatars/300-17.png" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="kt-menu-link flex items-center jistify-between gap-2">
                    <div class="flex items-center grow gap-2">
                      <div
                        ...
                        <img alt="" class="size-6 shrink-0"
                          src="/metronic/assets/media/brand-logos/google-webdev.svg" />
                      </div>
                      <div class="flex flex-col gap-0.5">
                        <a class="text-sm font-semibold text-mono hover:text-primary" href="#">
                          Google webdev
                    ...
                    <div class="flex justify-end shrink-0">
                      <div class="flex -space-x-2">
                        ...
                        <div class="flex">
                          <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                            src="/metronic/assets/media/avatars/300-20.png" />
                        </div>
                        <div class="flex">
                          <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-6"
                            src="/metronic/assets/media/avatars/300-21.png" />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="grid gap-1">
                  ...
                  <div class="kt-menu-item">
                    <div class="kt-menu-link flex justify-between gap-2">
                      <div class="flex items-center gap-2.5">
                        <img alt="" class="rounded-full size-9 shrink-0"
                          src="/metronic/assets/media/avatars/300-11.png" />
                        <div class="flex flex-col">
                          <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
                            Jacob Jones
                          </a>
                  ...
                  <div class="kt-menu-item">
                    <div class="kt-menu-link flex justify-between gap-2">
                      <div class="flex items-center gap-2.5">
                        <img alt="" class="rounded-full size-9 shrink-0"
                          src="/metronic/assets/media/avatars/300-5.png" />
                        <div class="flex flex-col">
                          <a class="text-sm font-semibold text-mono hover:text-primary mb-px" href="#">
                            TLeslie Alexander
                          </a>
              ...
              <div class="flex flex-col text-center py-9 gap-5">
                <div class="flex justify-center">
                  <img alt="image" class="dark:hidden max-h-[113px]"
                    src="/metronic/assets/media/illustrations/33.svg" />
                  <img alt="image" class="light:hidden max-h-[113px]"
                    src="/metronic/assets/media/illustrations/33-dark.svg" />
                </div>
    ...
    <div class="kt-modal" data-kt-modal="true" id="share_profile_modal">
      <div class="kt-modal-content max-w-[500px] top-5 lg:top-[15%]">
        ...
        <div class="kt-modal-body grid gap-5 px-0 py-5">
          ...
          <div class="kt-srcollable-y-auto max-h-[300px]">
          ...
          <div class="flex flex-col gap-5 p-5">
            ...
            <div class="flex flex-col gap-3.5">
              <label class="kt-form-label flex items-center gap-2.5">
                <input :checked="true" class="kt-radio radio-sm" name="report-option" type="radio" value="1" />
                <div class="flex flex-col gap-0.5">
              ...
              <label class="kt-form-label flex items-center gap-2.5">
                <input :checked="true" class="kt-radio radio-sm" name="report-option" type="radio" value="2" />
                <div class="flex flex-col gap-0.5">
                  <div class="text-sm font-semibold text-mono">
                    Spammy
                  </div>
              ...
              <label class="kt-form-label flex items-center gap-2.5">
                <input :checked="true" class="kt-radio radio-sm" name="report-option" type="radio" value="3" />
                <div class="flex flex-col gap-0.5">
                  <div class="text-sm font-semibold text-mono">
                    Off bumble behavior
                  </div>
              ...
              <label class="kt-form-label flex items-center gap-2.5">
                <input :checked="true" class="kt-radio radio-sm" name="report-option" type="radio" value="4" />
                <div class="flex flex-col gap-0.5">
                  <div class="text-sm font-semibold text-mono">
                    Something else
                  </div>
