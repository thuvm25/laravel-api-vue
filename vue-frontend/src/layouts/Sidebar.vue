    ...
    <div
        ...
        <div class="kt-sidebar-header hidden lg:flex items-center relative justify-between px-3 lg:px-6 shrink-0"
          ...
          <a class="dark:hidden" href="html/demo1.html">
            <img class="default-logo min-h-[22px] max-w-none" src="/metronic/assets/media/app/mini-logo.svg" />
        ...
        <div class="kt-sidebar-content flex grow shrink-0 py-5 pe-2" id="sidebar_content">
          <div class="kt-srcollable-y-hover grow shrink-0 flex ps-2 lg:ps-5 pe-1 lg:pe-3" data-kt-srcollable="true"
            data-kt-srcollable-dependencies="#sidebar_header" data-kt-srcollable-height="auto"
            data-kt-srcollable-offset="0px" data-kt-srcollable-wrappers="#sidebar_content" id="sidebar_srcollable">
            <!-- Sidebar Menu -->
