  ...
  <header class="flex lg:hidden items-center fixed z-10 top-0 start-0 end-0 shrink-0 bg-muted h-(--header-height)" id="header">
    ...
    <div class="kt-container-fluid flex items-center justify-between flex-wrap gap-3">
     <a href="html/demo4.html">
      <img class="dark:hidden min-h-[30px]" src="/metronic/assets/media/app/mini-logo-gray.svg"/>
      <img class="hidden dark:block min-h-[30px]" src="/metronic/assets/media/app/mini-logo-gray-dark.svg"/>
     </a>
